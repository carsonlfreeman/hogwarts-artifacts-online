...
class ArtifactControllerTest {
    ...
    @Test
    void testFindArtifactByIdSuccess() throws Exception { // Success scenario
        // Given
    ...
    @Test
    void testFindArtifactByIdNotFound() throws Exception { // Success scenario
        // Given
        given(this.artifactService.findById("1250808601744904191")).willThrow(new ArtifactNotFoundExpection("1250808601744904191"));
        // When and then together
        // Fake HTTP request
        this.mockMvc.perform(get("/api/v1/artifacts/1250808601744904191").accept(MediaType.APPLICATION_JSON))
    ...
    void testAddArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(post("/api/v1/artifacts").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON)) // Both sending and recieveing JSON data
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactSuccess() throws Exception {
        ...
        // When and Then
        this.mockMvc.perform(put("/api/v1/artifacts/1250808601744904192").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON)) // Both sending and recieveing JSON data
                .andExpect(jsonPath("$.flag").value(true))
                .andExpect(jsonPath("$.code").value(StatusCode.SUCCESS))
    ...
    void testUpdateArtifactErrorWithNonExistentId() throws Exception {
        ...
        given(this.artifactService.update(eq("1250808601744904192"),Mockito.any(Artifact.class))).willThrow(new ArtifactNotFoundExpection("1250808601744904192"));
        // When and Then
        this.mockMvc.perform(put("/api/v1/artifacts/1250808601744904192").contentType(MediaType.APPLICATION_JSON).content(json).accept(MediaType.APPLICATION_JSON)) // Both sending and recieveing JSON data
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
    ...
    void testDeleteArtifactErrorWithNonExistentId() throws Exception{
        // Given
        doThrow(new ArtifactNotFoundExpection("1250808601744904191")).when(this.artifactService).delete("1250808601744904191");
        // When and then
        this.mockMvc.perform(delete("/api/v1/artifacts/1250808601744904191").accept(MediaType.APPLICATION_JSON))
                .andExpect(jsonPath("$.flag").value(false))
                .andExpect(jsonPath("$.code").value(StatusCode.NOT_FOUND))
